...
(function() {
  'use strict';
  var VNode, VText, VTreeKup, extend, key, keys, parseSelector, vtreeKup, _i, _len,
    __slice = [].slice;
  ...
  VTreeKup = (function() {
    ...
    VTreeKup.prototype.tag = function() {
      var arg, args, children, i, name, properties, text, _i, _len;
      ...
      return this.topNodes().push(new VNode(name, properties, children, null, this.namespace));
    };

    VTreeKup.addKey = function(key) {
      return this.prototype[key] = function() {
        var args;
        args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
        return this.tag.apply(this, [key].concat(__slice.call(args)));
      };
    };
